          ...
          <div className="py-1">
            {Object.values(themes).map((theme) => (
              <button
                ...
                className={`w-full px-3 py-2 text-left text-xs hover:bg-[--color-terminal-text]/5 transition-colors flex items-center gap-2 ${
                  currentTheme === theme.name 
                    ? 'text-[--color-terminal-text] bg-[--color-terminal-text]/10' 
              ...
              >
                ...
                {currentTheme === theme.name && (
                  <span className="text-[--color-terminal-accent]" aria-label="Current theme">✓</span>
                )}
              </button>
            ))}
          </div>
