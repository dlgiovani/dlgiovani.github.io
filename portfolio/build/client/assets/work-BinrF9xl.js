...
`)}`,delay:1e4}),e.jsxs("div",{className:"mt-12 p-4 border border-[var(--color-terminal-secondary)] rounded",children:[e.jsx("div",{className:"text-[var(--color-terminal-accent)]",children:t.work.technologies.title}),e.jsxs("div",{className:"ml-4 text-[var(--color-terminal-secondary)] grid grid-cols-2 gap-4 mt-2",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-[var(--color-terminal-text)]",children:"Frontend:"}),e.jsx("div",{className:"whitespace-pre-line",children:t.work.technologies.frontend})]}),e.jsxs("div",{children:[e.jsx("div",{className:"text-[var(--color-terminal-text)]",children:"Backend:"}),e.jsx("div",{className:"whitespace-pre-line",children:t.work.technologies.backend})]}),e.jsxs("div",{children:[e.jsx("div",{className:"text-[var(--color-terminal-text)]",children:"Tools:"}),e.jsx("div",{className:"whitespace-pre-line",children:t.work.technologies.tools})]}),e.jsxs("div",{children:[e.jsx("div",{className:"text-[var(--color-terminal-text)]",children:"Integrations:"}),e.jsx("div",{className:"whitespace-pre-line",children:t.work.technologies.integrations})]})]})]})]})})});export{x as default,p as meta};
