...
function Layout({
  ...
  return /* @__PURE__ */ jsxs("html", {
    ...
    children: [/* @__PURE__ */ jsxs("head", {
      children: [/* @__PURE__ */ jsx("meta", {
        ...
        dangerouslySetInnerHTML: {
          __html: JSON.stringify({
            ...
            sameAs: ["https://dlgiovani.github.io", "https://github.com/dlgiovani", "https://linkedin.com/in/giovani-drosda-lima"],
      ...
      className: "bg-[var(--color-terminal-bg)] text-[var(--color-terminal-text)]",
...
function applyTheme(theme) {
  ...
  if (theme.backgroundImage) {
    ...
    root2.style.setProperty("--terminal-bg-image", bgImage);
    root2.style.setProperty("--terminal-bg-position", theme.backgroundImage.position);
    root2.style.setProperty("--terminal-bg-size", theme.backgroundImage.size);
    root2.style.setProperty("--terminal-bg-repeat", theme.backgroundImage.repeat);
    root2.style.setProperty("--terminal-bg-opacity", theme.backgroundImage.opacity.toString());
  } else {
    root2.style.removeProperty("--terminal-bg-image");
    root2.style.removeProperty("--terminal-bg-position");
    root2.style.removeProperty("--terminal-bg-size");
    root2.style.removeProperty("--terminal-bg-repeat");
    root2.style.removeProperty("--terminal-bg-opacity");
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "text-[var(--color-terminal-accent)]", children: "🌐" }),
          /* @__PURE__ */ jsx("span", { className: "text-xs font-mono", children: t.common.languages[currentLang] }),
          /* @__PURE__ */ jsx(
            "span",
            {
              className: `text-[var(--color-terminal-secondary)] transition-transform ${isOpen ? "rotate-180" : ""}`,
              children: "▼"
            }
          )
        ]
    ...
    isOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute top-full right-0 mt-1 z-20 bg-[var(--color-terminal-bg)] border border-[var(--color-terminal-secondary)] rounded shadow-lg min-w-[140px]", children: supportedLanguages.map((lang) => /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => handleLanguageChange(lang),
          className: `w-full px-3 py-2 text-left text-xs font-mono hover:bg-[var(--color-terminal-text)]/10 transition-colors first:rounded-t last:rounded-b ${currentLang === lang ? "text-[var(--color-terminal-text)] bg-[var(--color-terminal-text)]/5" : "text-[var(--color-terminal-secondary)]"}`,
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            currentLang === lang && /* @__PURE__ */ jsx("span", { className: "ml-auto text-[var(--color-terminal-accent)]", children: "✓" })
          ] })
        },
        lang
      )) })
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "py-1", children: Object.values(themes).map((theme) => /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `w-full px-3 py-2 text-left text-xs hover:bg-[var(--color-terminal-text)]/5 transition-colors flex items-center gap-2 ${currentTheme === theme.name ? "text-[var(--color-terminal-text)] bg-[var(--color-terminal-text)]/10" : "text-[var(--color-terminal-secondary)]"}`,
            role: "menuitem",
            type: "button",
            children: [
              /* @__PURE__ */ jsx(
              ...
              currentTheme === theme.name && /* @__PURE__ */ jsx("span", { className: "text-[var(--color-terminal-accent)]", "aria-label": "Current theme", children: "✓" })
            ]
          },
          theme.name
        )) })
      ...
      case "weather":
        if (args.length === 0) {
          ...
          fetchWeatherData(city).then((weather) => {
            setCommandHistory(
              (prev) => prev.map(
                (entry2) => entry2 === loadingEntry ? { ...entry2, output: weather } : entry2
              )
            );
          }).catch((error) => {
            setCommandHistory(
              (prev) => prev.map(
                (entry2) => entry2 === loadingEntry ? { ...entry2, output: t.terminal.outputs.weatherError.replace("{0}", city) } : entry2
              )
            );
          });
          return;
...
${t.terminal.themes.usage}`;
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("header", { className: "mb-6 border-b border-[var(--color-terminal-secondary)] pb-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-1", role: "presentation", "aria-label": "Terminal window controls", children: [
                /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full bg-[var(--color-terminal-error)]", "aria-label": "Close" }),
                /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full bg-[var(--color-terminal-accent)]", "aria-label": "Minimize" }),
                /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full bg-[var(--color-terminal-text)]", "aria-label": "Maximize" })
              ] }),
              /* @__PURE__ */ jsxs("span", { className: "text-[var(--color-terminal-secondary)] text-xs", role: "status", children: [
                "giovani@portfolio: ",
                currentPath
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxs("nav", { className: "space-y-1", role: "navigation", "aria-label": "Site navigation", children: [
            ...
            /* @__PURE__ */ jsxs("ul", { className: "ml-2 space-y-1 text-[var(--color-terminal-secondary)] list-none", children: [
...
function TerminalNavItem({ href, label, current }) {
  return /* @__PURE__ */ jsxs("li", { className: `terminal-tree ${current ? "text-[var(--color-terminal-text)] font-bold" : "text-[var(--color-terminal-secondary)]"}`, children: [
    /* @__PURE__ */ jsx(
      "a",
      {
        href,
...
> ${t.home.readme.location}`,
        ...
        className: "mt-12 p-4 border border-[var(--color-terminal-secondary)] rounded",
        children: [/* @__PURE__ */ jsx("div", {
          ...
          className: "ml-2 text-[var(--color-terminal-secondary)] space-y-1",
          children: [/* @__PURE__ */ jsx("div", {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              children: ["• ", /* @__PURE__ */ jsx("span", {
                className: "text-[var(--color-terminal-text)]",
...
Always exploring new technologies while maintaining production reliability.`,
        ...
        className: "mt-12 p-4 border border-[var(--color-terminal-secondary)] rounded",
        children: [/* @__PURE__ */ jsx("div", {
          className: "text-[var(--color-terminal-accent)]",
          children: t.about.quickStats.title
        }), /* @__PURE__ */ jsxs("div", {
          className: "ml-4 text-[var(--color-terminal-secondary)] space-y-1 mt-2",
          children: [/* @__PURE__ */ jsxs("div", {
...
${t.work.integrations.items.map((item) => `• ${item}`).join("\n")}`,
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          className: "ml-4 text-[var(--color-terminal-secondary)] grid grid-cols-2 gap-4 mt-2",
          children: [/* @__PURE__ */ jsxs("div", {
            children: [/* @__PURE__ */ jsx("div", {
              className: "text-[var(--color-terminal-text)]",
              children: "Frontend:"
...
giovani  1005  0.1  0.4  ${t.skills.categories.softSkills[4]}`,
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          className: "p-4 border border-[var(--color-terminal-secondary)] rounded",
          children: [/* @__PURE__ */ jsx("div", {
            className: "text-[var(--color-terminal-accent)] mb-2",
            children: "Skill Progression:"
          }), /* @__PURE__ */ jsx("div", {
            className: "text-[var(--color-terminal-secondary)] space-y-1 text-xs",
            children: /* @__PURE__ */ jsx("div", {
          ...
          children: [/* @__PURE__ */ jsx("div", {
            ...
            className: "ml-4 text-[var(--color-terminal-secondary)] space-y-1",
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxs("button", {
            ...
            children: [/* @__PURE__ */ jsx("div", {
              ...
              className: "ml-2 text-[var(--color-terminal-secondary)] group-hover:text-[var(--color-terminal-text)]",
              children: [/* @__PURE__ */ jsxs("div", {
                className: "text-[var(--color-terminal-accent)]",
...
${t.contact.inquiry.response.map((item) => `• ${item}`).join("\n")}`,
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          className: "text-[var(--color-terminal-secondary)] space-y-1",
          children: [/* @__PURE__ */ jsx("div", {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-uzEDDBYw.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": true, "module": "/assets/root-Y66BXmyg.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/index-CcACSQGc.js"], "css": ["/assets/root-BtuXgrQi.css"], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/home": { "id": "routes/home", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/home-NBPAM16a.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/about": { "id": "routes/about", "parentId": "root", "path": "about", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/about-BEOktWjR.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/work": { "id": "routes/work", "parentId": "root", "path": "work", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/work-BinrF9xl.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/skills": { "id": "routes/skills", "parentId": "root", "path": "skills", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/skills-oAhhiKO2.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/contact-DtHEAoXS.js", "imports": ["/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/pt/home": { "id": "routes/pt/home", "parentId": "root", "path": "pt", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/home-CHdAII23.js", "imports": ["/assets/home-NBPAM16a.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/pt/about": { "id": "routes/pt/about", "parentId": "root", "path": "pt/sobre", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/about-CklVP0PO.js", "imports": ["/assets/about-BEOktWjR.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/pt/work": { "id": "routes/pt/work", "parentId": "root", "path": "pt/trabalho", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/work-D_PwxVg4.js", "imports": ["/assets/work-BinrF9xl.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/pt/skills": { "id": "routes/pt/skills", "parentId": "root", "path": "pt/habilidades", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/skills-By1-xZ9f.js", "imports": ["/assets/skills-oAhhiKO2.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/pt/contact": { "id": "routes/pt/contact", "parentId": "root", "path": "pt/contato", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/contact-BAvIJbj4.js", "imports": ["/assets/contact-DtHEAoXS.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/fr/home": { "id": "routes/fr/home", "parentId": "root", "path": "fr", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/home-Dvkgxeaq.js", "imports": ["/assets/home-NBPAM16a.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/fr/about": { "id": "routes/fr/about", "parentId": "root", "path": "fr/à-propos", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/about-DeCEefzz.js", "imports": ["/assets/about-BEOktWjR.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/fr/work": { "id": "routes/fr/work", "parentId": "root", "path": "fr/travail", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/work-Cm1G_TkO.js", "imports": ["/assets/work-BinrF9xl.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/fr/skills": { "id": "routes/fr/skills", "parentId": "root", "path": "fr/compétences", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/skills-DzBitCPp.js", "imports": ["/assets/skills-oAhhiKO2.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/fr/contact": { "id": "routes/fr/contact", "parentId": "root", "path": "fr/contact", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/contact-DxUQgy3Q.js", "imports": ["/assets/contact-DtHEAoXS.js", "/assets/chunk-PVWAREVJ-D7LgcLjQ.js", "/assets/TypingText-Dugavqfp.js", "/assets/index-CcACSQGc.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/api/portfolio": { "id": "routes/api/portfolio", "parentId": "root", "path": "api/portfolio", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/portfolio-l0sNRNKZ.js", "imports": [], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-b366121d.js", "version": "b366121d", "sri": void 0 };
